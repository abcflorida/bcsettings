	...
	<div class="panel-body collapse" id="help-body">
		...
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1 help">
				...
				<h2>{{{ trans('platform/settings::common.title') }}}
					<small>
						<a class="manual" href="{{ url('https://cartalyst.com/manual/platform-settings') }}" target="_blank">
				...
				@content('platform-settings-help', 'platform/settings::content/help.md')
